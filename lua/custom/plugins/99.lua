...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('v', '<leader>9v', function() _99.visual() end, { desc = 'Complete' })

      --- if you have a request you dont want to make any changes, just cancel it
      vim.keymap.set('n', '<leader>9x', function() _99.stop_all_requests() end, { desc = 'Stop all' })

      vim.keymap.set('n', '<leader>9s', function() _99.search() end, { desc = 'Start discovery' })
    end,
  },
}
